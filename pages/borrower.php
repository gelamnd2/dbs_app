...
if(isset($_POST['add_borrower_address'])){
  ...
  $addressMessage = 'Borrower Address created successfully.';
 
} catch (Exception $e) {
  $addressStatus = 'error';
  $addressMessage = 'Error adding Borrower Address.';
}
}
            ...
            <form action="#" method="POST" class="row g-2">
              <div class="col-12">
                ...
                <select class="form-select" name="borrower_id" required>
                  ...
                  echo '<option value="'.$borrower['borrower_id'] .'">'.'['.$borrower['borrower_id'].'] '.$borrower
                  ['borrower_firstname']. ''.$borrower['borrower_lastname'].'</option>';
                 }   
                  ?>
...
<script>
  ...
  const addressStatus = <?php echo json_encode($addressStatus)?>;
 
  const addressMessage = <?php echo json_encode($addressMessage)?>;
