...
<script>
  ...
  const bookAddStatus = <?php echo json_encode($bookAddStatus)?>;
  const bookAddMessage = <?php echo json_encode($bookAddMessage)?>;
 
  if(bookAddStatus == 'success'){
    Swal.fire({
    icon: 'success',
    title: 'Success',
      text: bookAddMessage,
