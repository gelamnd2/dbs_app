...
<nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top">
  <div class="container">
    ...
    <div class="ms-auto d-flex gap-2">
      <a class="btn btn-sm btn-outline-secondary" href="books.php">Back</a>
          ...
          <div class="row g-3">
            <div class="col-12 col-md-6">
              ...
              <select class="form-select" name="borrower_id" required>
                ...
                <?php foreach ($activeBorrowers as $borrowers): ?>
                <option value="<?php echo $borrowers ['borrower_id']?>"><?php echo $borrowers['borrower_name']?></option>
                <?php endforeach; ?>
              </select>
            </div>
