...
if(isset($_POST['add_borrower'])){
  ...
  // 1. Collect and validate input from user
...
try {
  ...
  // 5. Insert into BorrowerUser mapping(lingking) table
...
$borrowerAddressCreateStatus = null;
$borrowerAddressCreateMessage = '';

if(isset($_POST['add_borrower_address'])){
 ...
 $borrower_id = $_POST['borrower_id'];
  ...
  try {
    ...
    $borrowerAddressCreateStatus = 'success';
    $borrowerAddressCreateMessage = 'BorrowerAddresss created successfully.';
   
  } catch (Exception $e) {
    $borrowerAddressCreateStatus = 'error';
        ...
        <div class="col-12 col-lg-6">
          <div class="card p-4 h-100">
            ...
            <form action="#" method="POST" class="row g-2">
              ...
              <div class="col-12">
                <button name="add_borrower_address" class="btn btn-outline-primary w-100" type="submit">Add Address</button>
              </div>
            </form>
          </div>
        </div>
...
<script>
  ...
  const addressStatus = <?php echo json_encode($borrowerAddressCreateStatus)?>;
  const addressMessage = <?php echo json_encode($borrowerAddressCreateMessage)?>;
 ...
 <script>
  ...
  const addBookMessage = <?php echo json_encode($addBookCreateMessage)?>;
